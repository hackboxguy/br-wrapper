...
BRBOX_GENINTRDRV_SITE = $(BR2_EXTERNAL_BRWRAPPER_PATH)/package/sources/kmods/genintrdrv
#$(TOPDIR)/../sources/kmods/genintrdrv
...
BRBOX_GENINTRDRV_MODULE_MAKE_OPTS = -Wno-unused-function
...
define BRBOX_GENINTRDRV_INSTALL_INIT_SYSV
        $(INSTALL) -D -m 0755 $(BR2_EXTERNAL_BRWRAPPER_PATH)/package/brbox_genintrdrv/S59GenIntrDrvModule \
